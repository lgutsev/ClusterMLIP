...
class PipelineTests(unittest.TestCase):
    ...
    def test_spin_ladder_inserts_every_single_flip(self):
        ...
        self.assertIn(" NoSymm Opt IOP", DEFAULT_SPIN_ROUTE)
        self.assertNotIn("RFO", DEFAULT_SPIN_ROUTE)
        self.assertNotIn("MaxCycle=70", DEFAULT_SPIN_ROUTE)
        self.assertNotIn("Pop=", DEFAULT_SPIN_ROUTE)
        self.assertNotIn("Pop=Full", DEFAULT_SPIN_ROUTE)
        self.assertNotIn("SpinDensity", DEFAULT_SPIN_ROUTE)
        self.assertNotIn("Stable=Opt", DEFAULT_SPIN_ROUTE)
